...
def data_operation(conversation, parse_text, i, **kwargs):
    ...
    text = f"The data contains information related to {description}.\n\n"
    ...
    text += f"The exact feature names in the data are listed as follows:{f_string}\n\n"
    ...
    text += "Let me know if you want to see an in depth description of the dataset statistics.\n\n"
